<script setup>
import { Panel, VueFlow, isNode, useVueFlow, Position } from '@vue-flow/core'
...
const { onPaneReady, onNodeDragStop, onConnect, updateEdge, addEdges, setTransform, toObject, findNode, project, vueFlowRef, addNodes, getNode } = useVueFlow()
...
<template>
  <div class="dndflow" @drop="onDrop">
    ...
    <VueFlow v-model="elements" :class="{ dark }" class="basicflow" :default-viewport="{ zoom: 1.5 }" :min-zoom="0.2"
      :max-zoom="4" @edge-update="onEdgeUpdate" @dragover="onDragOver">
