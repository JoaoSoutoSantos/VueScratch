...
export const initialElements = [
    { id: '1', type: 'default', label: 'Node 01', position: { x: 250, y: 0 }, class: 'light' },
    { id: '2', type: 'default', label: 'Node 02', position: { x: 100, y: 100 }, class: 'light' },
    { id: '3', type: 'default', label: 'Node 03', position: { x: 400, y: 100 }, class: 'light' },
    //{ id: '4', label: 'Node 4', position: { x: 150, y: 200 }, class: 'light' },
    //{ id: '5', type: 'output', label: 'Node 05', position: { x: 300, y: 300 }, class: 'light' },
    { id: 'e1-2', source: '1', target: '2', animated: true, updatable: true, markerEnd: MarkerType.ArrowClosed },
